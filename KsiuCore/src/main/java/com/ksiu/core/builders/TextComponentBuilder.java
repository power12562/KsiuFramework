...
public class TextComponentBuilder
{
    ...
    @NotNull
    public TextComponentBuilder shadowColorIfAbsent(@Nullable ARGBLike argb)
    {
        _builder.shadowColorIfAbsent(argb);
        return this;
    }
    ...
    @NotNull
    public TextComponentBuilder shadowColor(@Nullable ARGBLike argb)
    {
        _builder.shadowColor(argb);
        return this;
    }
